...
while(True):
	...
	newrightr=int(rightr*4/(im.size[0]*im.size[1]/3))
	newrightg=int(rightg*4/(im.size[0]*im.size[1]/3))
	newrightb=int(rightb*4/(im.size[0]*im.size[1]/3))

	newleftr=int(leftr*4/(im.size[0]*im.size[1]/3))
	newleftg=int(leftg*4/(im.size[0]*im.size[1]/3))
	newleftb=int(leftb*4/(im.size[0]*im.size[1]/3))
